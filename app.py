...
def pagina_resultados():
    ...
    ax1.plot(semanas_interp, interp_p3_peso(semanas_interp), '--', label='P3')
    ax1.plot(semanas_interp, interp_p10_peso(semanas_interp), '--', label='P10')
    ax1.scatter(ig_total, peso_fetal, color=cor_ponto(peso_fetal, interp_p3_peso(ig_total), interp_p10_peso(ig_total)), label='Peso do bebê')
    ax1.set_title("Peso fetal (g)")
    ...
    ax2.plot(semanas_interp, interp_p3_ca(semanas_interp), '--', label='P3')
    ax2.plot(semanas_interp, interp_p10_ca(semanas_interp), '--', label='P10')
    ax2.scatter(ig_total, circ_abdominal, color=cor_ponto(circ_abdominal, interp_p3_ca(ig_total), interp_p10_ca(ig_total)), label='Circunferência abdominal')
